...
class IzVariables(IzContainer):
    ...
    properties = {
        ...
        REFERENCE_SPEC_FILES: ["izpack/install.xml",
                               "resources/userInputSpec.xml",
                               "izpack/ProcessPanel.Spec.xml",
                               "izpack/core-packs.xml",
                               "izpack/conditions.xml",
                               "izpack/variables.xml",
                               "izpack/dynamic_variables.xml"],
        ATTRIBUTES: ['variable'],
